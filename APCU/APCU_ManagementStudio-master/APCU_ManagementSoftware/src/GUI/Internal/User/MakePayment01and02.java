...
public class MakePayment01and02 extends javax.swing.JInternalFrame {
    
    
    
    public MakePayment01and02(JDesktopPane pDesktop, int TID, int MID) {
        initComponents();
        nonMove();
        tableNonMove();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("                (Make Payment Step 03 & 04)");
    ...
    private void NextLMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NextLMouseClicked
        if(TIDL.getText()=="Tournament ID will appear here" || MIDL.getText()=="Match ID will appear here"){
            ...
            int input = JOptionPane.showConfirmDialog(null, "Are you sure that you want to manage payment to be payed of Match ID = '"+MIDL.getText()+"'");
            
            if(input==0){
                MakePayment03and04 MUA = new MakePayment03and04(Desktop,MIDL.getText());
                Desktop.add(MUA);
                this.dispose();
                MUA.setVisible(true);
            }
